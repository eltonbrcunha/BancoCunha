...
namespace BancoCunha.Migrations
{
    ...
    [Migration("20210916020612_Inicial02")]
            ...
            modelBuilder.Entity("BancoCunha.Models.Conta", b =>
                {
                    ...
                    b.Property<int?>("SaldoPessoaIdSaldo")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BancoCunha.Models.Conta", b =>
                {
                    ...
                    b.HasOne("BancoCunha.Models.SaldoPessoa", "SaldoPessoa")
                        .WithMany()
                        .HasForeignKey("SaldoPessoaIdSaldo");
                });
